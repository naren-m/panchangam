...
async function manualTest() {
  ...
  try {
    ...
    console.log('PASS: Header verified\n');
    ...
    console.log('PASS: Previous month clicked\n');
    ...
    await nextBtn.click({ timeout: 5000 }).catch(() => page.locator('button').nth(1).click());
    await page.waitForTimeout(1000);
    console.log('PASS: Next month clicked twice\n');
    ...
    await page.waitForTimeout(1000);
    console.log('PASS: Today button clicked\n');
    ...
    await page.waitForTimeout(2000);
    console.log('PASS: Table view activated\n');
    ...
    await page.waitForTimeout(2000);
    console.log('PASS: Analytics view activated\n');
    ...
    await page.waitForTimeout(1000);
    console.log('PASS: Calendar view activated\n');
    ...
    console.error('FAIL: Test failed:', message);
